...
export class Backend implements backendInterface {
    ...
    async createTopic(arg0: Topic): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createTopic(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentlyWatched(): Promise<Array<RecentlyWatched>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentlyWatched();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordRecentlyWatched(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordRecentlyWatched(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchTopicsByKeyword(arg0: string): Promise<Array<Topic>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchTopicsByKeyword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTopic(arg0: Topic): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTopic(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
